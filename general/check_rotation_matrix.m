function isRotationMatrix = check_rotation_matrix(matrix, verbose, eps)
    ...
    isNormal = check_normality(matrix, verbose, eps);

    % Check if the matrix is orthogonal
    isOrthogonal = check_orthogonality(matrix, verbose, eps);

    % Compute the determinant of the matrix
    determinant = compute_determinant(matrix, verbose);
