function R = get_elementary_rotation_matrix(axis, s)
    % This function returns an elementary rotation matrix for a given axis and angle.
    % Input: axis - a character indicating the axis of rotation ('x', 'y', or 'z')
    %        s - the angle of rotation in radians
    % Output: R - the 3x3 rotation matrix corresponding to the specified axis and angle
    ...
    switch axis
        ...
        otherwise
            ...
            R = []; % Return an empty matrix in case of an invalid axis
    end
end
